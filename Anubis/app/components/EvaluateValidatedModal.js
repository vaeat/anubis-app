...
export default class EvaluateValidatedModal extends Component {
  constructor(props){
    super(props);
    this.state = {
...
closeEvaluateValidatedModal = () => {
  this.props.changeEvaluateValidatedModalVisibility(false);
}
...
render(){
  return(
    <TouchableOpacity activeOpacity={1} disabled={true} style={styles.contentContainer}>
      ...
      <TouchableHighlight onPress={() => this.closeEvaluateValidatedModal()} style={styles.closeButtonText}>
        <Text>x</Text>
      </TouchableHighlight>
        ...
        <View style={styles.buttonView}>
          <TouchableHighlight onPress={() => this.closeEvaluateValidatedModal()} style={styles.touchableHighlight}>
